...
namespace ff {
	...
	namespace MaterialName {
		...
		static const std::string MeshPcssMaterial = "MeshPcssMaterial";
		static const std::string SsrMaterial = "SsrMaterial";
		static const std::string SsrGbufferMaterial = "SsrGbufferMaterial";
		static const std::string SsrDepthMaterial = "SsrDepthMaterial";
		static const std::string PrtMaterial = "PrtMaterial";
		static const std::string BrdfMaterial = "BrdfMaterial";
		static const std::string KullaContyMaterial = "KullaContyMaterial";
		static const std::string AreaLightMaterial = "AreaLightMaterial";
	};

	//material Type---------------
	enum MaterialType {
		MeshBasicMaterialType,
		MeshPhongMaterialType,
		CubeMaterialType,
		DepthMaterialType,
		MeshPcssMaterialType,
		SsrMaterialType,
		SsrGbufferMaterialType,
		SsrDepthMaterialType,
		PrtMaterialType,
		BrdfMaterialType,
		KullaContyMaterialType,
	...
	enum class TextureUsage {
		SamplerTexture,              //������ΪͼƬ�����������
		RenderTargetTexture          //������Ϊ��Ⱦ���󣬱�����Ϊһ��ֽ������������Ⱦ����������ϣ�����������Ⱦ����
	};
